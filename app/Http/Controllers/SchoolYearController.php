...
class SchoolYearController extends Controller
{
     ...
     * l'activation classique : réservée au Super Administrateur, avec reconfirmation du
     * mot de passe de connexion (même principe que ProfileController::destroy()) en
     * attendant le vrai « code de sécurité admin » distinct du mot de passe, pas encore
     * construit (mission Sécurité).
     */
    ...
    public function reopen(Request $request, SchoolYear $schoolYear): RedirectResponse
    {
        $this->authorize('deverrouiller-annee-scolaire', $schoolYear);
