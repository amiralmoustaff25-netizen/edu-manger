...
<div x-data="{ open: {{ $open ? 'true' : 'false' }} }">
    <button @click="open = !open" :aria-expanded="open.toString()" class="w-full flex items-center justify-between gap-2 px-2 py-2 text-sm font-semibold text-left text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 rounded-md group">
