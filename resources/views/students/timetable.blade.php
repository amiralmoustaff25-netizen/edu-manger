    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if($registration && $registration->classroom)
                ...
                {{-- Vraie grille horaire (App\Models\TimetableEntry), tous cycles — remplace
                     l'ancienne liste "matières & heures" (secondaire) qui n'était qu'un
                     substitut basé sur l'ancien pivot teacher_classroom, jamais alimenté.
                     Lecture seule ici : la modification se fait depuis timetable.edit
                     (professeur principal/titulaire, surveillant ou admin). --}}
