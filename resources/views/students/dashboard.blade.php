            ...
            <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg mt-6">
                <div class="p-6 border-b border-gray-100 dark:border-slate-700">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        @foreach(\App\Support\AcademicPeriods::forCycle($registration?->classroom?->cycle) as $period => $label)
                            <div class="rounded-md border border-gray-200 dark:border-slate-700 p-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <a href="{{ route('bulletins.show', [$user, $period]) }}" class="px-3 py-1.5 bg-indigo-600 text-white text-xs rounded-md hover:bg-indigo-700">Voir</a>
