...
<div class="grid gap-5 md:grid-cols-2">
    <div>
        ...
        <input id="name" name="name" value="{{ old('name', $user->name) }}" type="text" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <div>
        ...
        <select id="role" name="role" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
...
@if(! $user->exists)
    <div class="mt-5 rounded-md bg-indigo-50 dark:bg-indigo-900/50 p-4 text-sm text-indigo-800 dark:text-indigo-300">
