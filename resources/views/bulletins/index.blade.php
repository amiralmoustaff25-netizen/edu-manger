                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                                ...
                                <div class="flex gap-2">
                                    @foreach(\App\Support\AcademicPeriods::forCycle($classroom->cycle) as $code => $label)
                                        <form action="{{ route('bulletins.class-pdf', [$classroom, $code]) }}" method="GET" data-no-pjax class="flex-1">
