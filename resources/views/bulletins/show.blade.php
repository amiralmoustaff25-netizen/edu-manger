        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <div class="flex gap-2">
                    <a href="{{ auth()->user()->hasRole('eleve') ? route('student.bulletins') : route('bulletins.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition">
                ...
                <div class="flex gap-2">
                    <form action="{{ route('bulletins.pdf', [$bulletin['student'], $period]) }}" method="GET" data-no-pjax class="inline">
